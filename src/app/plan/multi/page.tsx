              ...
              <Card key={idx} className="overflow-hidden">
                <CardHeader className="bg-gray-50 border-b">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <Badge variant="secondary" className="text-lg px-3 py-1">{idx + 1}</Badge>
                ...
                <CardContent className="p-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h4 className="font-medium flex items-center gap-2 mb-3">
                        <Hotel className="w-4 h-4 text-orange-500" /> Hotel Options
                      </h4>
                      {dest.hotels.length > 0 ? (
                        <div className="space-y-2">
                          {dest.hotels.slice(0, 3).map((hotel) => (
                            <div key={hotel.id} className="p-3 bg-gray-50 rounded-lg text-sm">
                              ...
                              <div className="flex justify-between items-center text-gray-600">
                                <span>{formatCurrency(hotel.price.perNight)}/night</span>
                                <span className="font-semibold">Total: {formatCurrency(hotel.price.total)}</span>
                              </div>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="mt-3 pt-3 border-t">
                        <p className="text-sm">
                          <strong>Est. Hotel Cost:</strong> {formatCurrency(dest.hotelTotal)} ({formatCurrency(dest.hotelCostPerNight)}/night)
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">
                  {destinations.length}/5 cities
                </Badge>
              </div>

              <div className="space-y-4">
                {destinations.map((dest, index) => (
                  <div key={dest.id} className="p-4 bg-gray-50 rounded-lg border border-gray-200">
